    ...
    def from_texts(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            ids: Optional list of IDs associated with the texts (unused in this
                implementation as IDs are generated by the Ontology).
        ...
        Raises:
            ValueError: If required kwargs (vector_store, vector_property, actions)
                are not provided.
        """
        vector_store = kwargs.get("vector_store")
        vector_property = kwargs.get("vector_property")
        actions = kwargs.get("actions")
        if vector_store is None or vector_property is None or actions is None:
            raise ValueError(
                "Required kwargs 'vector_store', 'vector_property', and 'actions' must be provided"
            )
